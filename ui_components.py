...
def create_main_ui(root, open_callback):
    ...
    rgb_button_frame = Frame(scrollable_frame)
    rgb_button_frame.pack(pady=10)

    red_btn = Button(rgb_button_frame, text="Show Red Channel", bg="#ffcccc", font=("Arial", 10, "bold"))
    red_btn.pack(side=LEFT, padx=5)

    green_btn = Button(rgb_button_frame, text="Show Green Channel", bg="#ccffcc", font=("Arial", 10, "bold"))
    green_btn.pack(side=LEFT, padx=5)

    blue_btn = Button(rgb_button_frame, text="Show Blue Channel", bg="#ccccff", font=("Arial", 10, "bold"))
